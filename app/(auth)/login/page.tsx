        ...
        <div style={{
          ...
          <div style={{ marginTop: 40, paddingTop: 20, borderTop: "1px solid var(--bd-1)" }}>
            <p style={{ fontSize: 12, color: "var(--tx-3)", lineHeight: 1.6 }}>
              Klaxon connects manufacturers, distributors, pharmacies, and PPMVs on a single verified supply chain platform.
            </p>
          </div>
        </div>
        ...
        <div style={{ background: "var(--bg-surface)", padding: 48, display: "flex", flexDirection: "column", justifyContent: "center" }}>
          ...
          <form onSubmit={handleLogin} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 5 }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input type={showPwd ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)}
                  className="kx-input" style={{ paddingLeft: 32, paddingRight: 36 }} placeholder="Your password" required />
                <button type="button" onClick={() => setShowPwd((v) => !v)}
                  style={{ position: "absolute", right: 10, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", color: "var(--tx-3)", display: "flex", alignItems: "center", padding: 0 }}>
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", marginTop: -6 }}>
              <a href="/forgot-password" style={{ fontSize: 11, color: "var(--tx-3)", textDecoration: "none" }}
