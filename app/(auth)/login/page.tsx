...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // If auth store throws, fall back to local demo-account check
        ...
        >
          ...
          <div
            style={{
              ...
              background: "radial-gradient(circle, rgba(20,184,142,0.12) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          <div
            style={{
              ...
              background: "radial-gradient(circle, rgba(20,184,142,0.06) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
        ...
        >
          ...
          >
            ...
            <div style={{ display: "flex", justifyContent: "flex-end", marginTop: -6 }}>
                ...
                style={{ fontSize: 11, color: "var(--tx-3)", textDecoration: "none" }}
          ...
          >
            <p style={{ fontSize: 12, color: "var(--tx-3)" }}>
              Don&apos;t have an account?{" "}
                ...
                href="/register"
                style={{ color: "var(--k)", textDecoration: "none", fontWeight: 600 }}
              >
                Create account
              </a>
            </p>
            <p style={{ fontSize: 11, color: "var(--tx-3)" }}>
              Click any demo account on the left to auto-fill
            </p>
          </div>
        </div>
      </div>
