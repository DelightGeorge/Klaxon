...
const cols: Col<RFQ>[] = [
  ...
  {key:"quantity",header:"Quantity",render:r=><span style={{fontFamily:"'DM Mono',monospace"}}>{r.quantity.toLocaleString()}</span>},
...
export default function RFQPage() {
  return (
    <div>
      <PageHeader title="Request for Quotation" subtitle="Manage supplier RFQs" action={<button className="btn-primary btn-sm">+ New RFQ</button>}/>
