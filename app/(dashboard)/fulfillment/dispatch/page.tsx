...
export default function DispatchPage() {
  ...
  return (<div><PageHeader title="Dispatch Management" subtitle={`${pending.length} orders ready to dispatch`}/><DataTable columns={cols} data={pending as unknown as Record<string,unknown>[]}/></div>);
}