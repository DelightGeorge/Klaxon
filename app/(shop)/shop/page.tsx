...
const MOCK_DRUGS: Drug[] = [
  {
    ...
    description:
      "Effective pain reliever and fever reducer. Suitable for adults and children over 12.",
    mockImage:
  ...
  },
  {
    ...
    description:
      "Broad-spectrum antibiotic for bacterial infections. Requires valid prescription.",
    mockImage:
  ...
  },
  {
    ...
    dosageForm: "TABLET",
    strength: "1000mg",
    manufacturer: "Healthplus Nigeria",
    description:
      "High-strength vitamin C supplement. Boosts immunity and supports collagen production.",
    mockImage:
  ...
  },
  {
    ...
    description:
      "First-line treatment for type 2 diabetes. Controls blood sugar levels effectively.",
    mockImage:
  ...
  },
  {
    ...
    description:
      "Proton pump inhibitor for acid reflux, heartburn and stomach ulcers.",
    mockImage:
  ...
  },
  {
    ...
    description:
      "ACE inhibitor for high blood pressure and heart failure management.",
    mockImage:
  ...
  },
  {
    ...
    manufacturer: "Emzor",
    description:
      "NSAID pain reliever, anti-inflammatory. For headaches, muscle pain, menstrual cramps.",
    mockImage:
  ...
  },
  {
    ...
    genericName: "Zinc Sulphate + Cholecalciferol",
    brand: "Recharge",
    category: "VITAMIN",
    type: "OTC",
    unit: "tablets",
    sellingPrice: 3200,
    dosageForm: "TABLET",
    strength: "50mg/1000IU",
    manufacturer: "Ranbaxy Nigeria",
    description:
      "Immunity booster combo. Zinc supports immune function, Vitamin D3 for bone health.",
    mockImage:
  ...
  },
  {
    ...
    description:
      "Antimalarial treatment and prophylaxis. Effective against Plasmodium falciparum.",
    mockImage:
  ...
  },
  {
    ...
    manufacturer: "Pfizer",
    description:
      "Statin medication for lowering LDL cholesterol and reducing cardiovascular risk.",
    mockImage:
  ...
  },
  {
    ...
    dosageForm: "POWDER",
    strength: "Standard",
    manufacturer: "UNICEF Nigeria",
    description:
      "Oral rehydration therapy for diarrhoea and dehydration. Safe for all ages.",
    mockImage:
  ...
  },
  {
    ...
    description:
      "Essential B vitamin for pregnant women. Prevents neural tube defects in newborns.",
    mockImage:
...
export default function ShopPage() {
  ...
  const [orgs, setOrgs] = useState<PartnerOrg[]>(MOCK_ORGANIZATIONS);
  ...
  useEffect(() => {
    ...
    api
      ...
      .catch(() => {
        if (!cancelled) setDrugs(MOCK_DRUGS);
      })
      .finally(() => {
  ...
  // Connected organizations/pharmacies strip. Tries the real network
  // endpoint once; if it 404s, errors, or comes back empty (unseeded
  // demo deploy) it just keeps the mock list already in state.
  useEffect(() => {
    let cancelled = false;
    api.get("/organizations/public")
      .then(r => {
        if (cancelled) return;
        const d = r.data as { organizations?: PartnerOrg[]; data?: PartnerOrg[] };
        const real = d.organizations ?? d.data ?? [];
        if (real.length > 0) setOrgs(real);
      })
      .catch(() => { /* keep mock orgs */ });
    return () => { cancelled = true; };
  }, []);
  ...
  const addToCart = (drug: Drug) => {
    storeAddItem(drug as StoreCartItem);
  };

  const updateQty = (id: string, delta: number) => {
    storeUpdateQty(id, delta);
  };
        ...
        >
          ...
          >
            <div style={{ flex: 1, minWidth: 0 }}>
                ...
                {drug.badge && (
                  <span
                    style={{
                      ...
                      padding: "2px 6px",
                      borderRadius: 99,
                      background: `${BADGE_COLORS[drug.badge]}20`,
                      color: BADGE_COLORS[drug.badge],
                      fontWeight: 700,
              ...
              <p
                style={{ fontSize: 11, color: "var(--tx-3)", marginBottom: 4 }}
              >
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div style={{ textAlign: "right" }}>
                ...
                >
                  ₦{(drug.sellingPrice ?? 0).toLocaleString()}
                </p>
      ...
      >
        ...
        >
          {drug.mockImage ? (
            ...
            >
              <Package
                style={{ width: 32, height: 32, color: "var(--tx-3)" }}
              />
            </div>
          )}
          {drug.badge && (
            <span
              style={{
                ...
                padding: "3px 7px",
                borderRadius: 99,
                background: BADGE_COLORS[drug.badge] ?? "var(--k)",
                color: "#07080a",
                fontWeight: 800,
                fontFamily: "'DM Mono',monospace",
              }}
     ...
     {/* ── Topbar ── */}
      ...
      >
        ...
        >
          ...
          <span style={{ color: "var(--bd-2)", fontSize: 18, flexShrink: 0 }}>
            /
          </span>
          <span
            style={{
          ...
          >
            <ShoppingCart
              style={{ width: 15, height: 15, color: "var(--k)" }}
            />
            <span
              style={{ fontSize: 12, fontWeight: 600, display: "none" }}
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", padding: "20px 16px" }}>
        ...
        <div
          style={{
            borderRadius: 16,
            background:
              "linear-gradient(135deg, #0d1a15 0%, #0c0e12 60%, #111318 100%)",
            border: "1px solid var(--bd-k)",
            padding: "24px 28px",
            marginBottom: 20,
            position: "relative",
        ...
        >
          <div
            style={{
              ...
              borderRadius: "50%",
              background:
                "radial-gradient(circle, rgba(20,184,142,0.15) 0%, transparent 70%)",
              pointerEvents: "none",
            }}
          />
          <div style={{ position: "relative" }}>
            ...
            >
              Order verified OTC medicines and supplements from NAFDAC-licensed
              distributors. Fast delivery across Nigeria.
            </p>
            <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
              {[
                {
                  icon: <Truck style={{ width: 13, height: 13 }} />,
                  text: "Free delivery over ₦10,000",
                },
                {
                  icon: <Shield style={{ width: 13, height: 13 }} />,
                  text: "NAFDAC verified",
                },
                {
                  icon: <Clock style={{ width: 13, height: 13 }} />,
                  text: "Same-day Lagos delivery",
                },
                {
                  icon: <Zap style={{ width: 13, height: 13 }} />,
                  text: "Express 3-hour option",
                },
              ].map((b) => (
                <div
                  key={b.text}
        ...
        {ordered && (
          ...
          >
            ...
            <div>
              <p
                style={{ fontSize: 13, color: "var(--tx-1)", fontWeight: 600 }}
              >
        ...
        {/* Connected pharmacy/organization network */}
        <div style={{ marginBottom: 20 }}>
          ...
          >
            ...
            >
              You&apos;re connected to {orgs.length}+ verified pharmacies &amp;
              organizations
            </p>
            <span
              style={{
        ...
        >
          ...
          >
            {CATEGORIES.map((c) => (
              ...
              >
                {c === "All" ? "All Products" : c.replace(/_/g, " ")}
              </button>
            ))}
          </div>
          ...
          <div style={{ position: "relative", flexShrink: 0 }}>
            ...
            >
              <Tag style={{ width: 12, height: 12 }} /> {sort}{" "}
                ...
                {SORT_OPTIONS.map((s) => (
                  <button
                    ...
                    style={{
                      ...
                      padding: "8px 12px",
                      borderRadius: 8,
                      background: sort === s ? "var(--k-subtle)" : "none",
                      border: "none",
                      cursor: "pointer",
                      fontSize: 12,
                      color: sort === s ? "var(--k)" : "var(--tx-2)",
                    }}
                  >
                    {s}
                  </button>
          ...
          <button
            ...
            style={{
              ...
              padding: "6px 12px",
              borderRadius: 10,
              background: showFilter ? "var(--k-subtle)" : "var(--bg-surface)",
              border: `1px solid ${showFilter ? "var(--bd-k)" : "var(--bd-1)"}`,
              cursor: "pointer",
              fontSize: 11,
              color: showFilter ? "var(--k)" : "var(--tx-2)",
              flexShrink: 0,
            }}
          >
            ...
            {(["grid", "list"] as const).map((m) => (
              <button
                ...
                style={{
                  padding: "6px 10px",
                  background:
                    viewMode === m ? "var(--k-subtle)" : "transparent",
                  border: "none",
                  cursor: "pointer",
                  color: viewMode === m ? "var(--k)" : "var(--tx-3)",
                  display: "flex",
                }}
              >
                {m === "grid" ? (
          ...
          >
            <div style={{ flex: 1, minWidth: 200 }}>
              ...
              <div style={{ display: "flex", gap: 6 }}>
                {[
                  { label: "All", v: null },
                  { label: "OTC Only", v: false },
                  { label: "Rx Only", v: true },
                ].map((o) => (
                  <button
                    key={o.label}
                    onClick={() => setRxOnly(o.v)}
                    style={{
                      padding: "5px 12px",
                      borderRadius: 99,
                      fontSize: 11,
                      cursor: "pointer",
                      border: "1px solid",
                      borderColor: rxOnly === o.v ? "var(--k)" : "var(--bd-1)",
                      background:
                        rxOnly === o.v ? "var(--k-subtle)" : "transparent",
                      color: rxOnly === o.v ? "var(--k)" : "var(--tx-3)",
                    }}
                  >
                    {o.label}
                  </button>
            ...
            <div style={{ flex: 2, minWidth: 240 }}>
              ...
              <input
                ...
                style={{ width: "100%", accentColor: "var(--k)" }}
              />
              <div
                style={{
                  display: "flex",
        ...
        >
          <p style={{ fontSize: 12, color: "var(--tx-3)" }}>
            ...
            {cat !== "All" && (
              <span style={{ color: "var(--k)", marginLeft: 4 }}>
                in {cat.replace(/_/g, " ")}
              </span>
            )}
          </p>
        ...
        {initialLoading ? (
          ...
          >
            <Loader2
              style={{ width: 28, height: 28, color: "var(--k)" }}
          ...
          <div style={{ textAlign: "center", padding: 64 }}>
            ...
            />
            <p style={{ fontSize: 14, color: "var(--tx-2)", fontWeight: 600 }}>
              No medicines found
            </p>
                  ...
                  {cart.map((item) => (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <Plus
                            style={{ width: 8, height: 8, color: "#07080a" }}
                          />
                        </button>
                      </div>
                    </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <span
                      style={{
                        fontSize: 12,
                        color: deliveryFee === 0 ? "var(--k)" : "var(--tx-1)",
                      }}
                    >
                      {deliveryFee === 0
                        ? "FREE"
                  ...
                  {deliveryFee > 0 && (
                    <p style={{ fontSize: 10, color: "var(--tx-3)" }}>
                      Add ₦{(10000 - total).toLocaleString()} more for free
                      delivery
                    </p>
                  )}
                  <div
                ...
                >
                  {ordering ? (
                    ...
                    <>
                      Place Order · ₦{(total + deliveryFee).toLocaleString()}{" "}
                ...
                >
                  ...
                  />
                  Secured payment · NAFDAC verified products
                </p>
                {cart.length > 0 && (
                  <Link
                    href="/shop/checkout"
                  ...
                  >
                    Prefer delivery options &amp; payment method? Full checkout →
                  </Link>
                )}
              </div>
            )}
          ...
          >
            <div style={{ position: "relative" }}>
              {selected.mockImage ? (
                ...
                >
                  <Package
                    style={{ width: 48, height: 48, color: "var(--tx-3)" }}
                  />
                </div>
              )}
              <button
              ...
              >
                <X style={{ width: 16, height: 16, color: "var(--tx-1)" }} />
              </button>
              <button
                onClick={() => setSelected(null)}
                style={{
              ...
              >
                <ChevronLeft
                  style={{ width: 16, height: 16, color: "var(--tx-1)" }}
                />
              </button>
            </div>
            ...
            <div style={{ padding: "20px 20px 24px" }}>
                  ...
                  {selected.badge && (
                    <span
                      style={{
                        ...
                        padding: "2px 7px",
                        borderRadius: 99,
                        background: `${BADGE_COLORS[selected.badge]}20`,
                        color: BADGE_COLORS[selected.badge],
                        fontWeight: 700,
                        fontFamily: "'DM Mono',monospace",
                ...
                >
                  <Heart
                    style={{
                      width: 15,
                      height: 15,
                      fill: wishlist.includes(selected.id) ? "#f43f5e" : "none",
                      color: wishlist.includes(selected.id)
                        ? "#f43f5e"
                        : "var(--tx-3)",
                    }}
                  />
              ...
              >
                {[
                  ...
                  {
                    label: "Category",
                    value: selected.category?.replace(/_/g, " "),
                  },
              ...
              >
                <div>
                  ...
                  >
                    ₦{(selected.sellingPrice ?? 0).toLocaleString()}
                  </p>
                ...
                {cart.find((i) => i.id === selected.id) ? (
                  ...
                  >
                    <button
                      onClick={() => updateQty(selected.id, -1)}
                      style={{
                        width: 32,
                        height: 32,
                        borderRadius: 8,
                    ...
                    >
                      {cart.find((i) => i.id === selected.id)?.qty}
                    </span>
                    <button
                      onClick={() => updateQty(selected.id, 1)}
                      style={{
                    ...
                    >
                      <Plus
                        style={{ width: 12, height: 12, color: "#07080a" }}
                      />
                    </button>
                  </div>
                ) : (
                  <button
                    ...
                    className="btn-primary btn-sm"
                  >
                    <ShoppingCart style={{ width: 14, height: 14 }} /> Add to
                    Cart
                  </button>
                )}
              </div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)" }}>
          {[
            ...
            >
              ...
              <span
                style={{
                  color: mobileTab === tab.id ? "var(--k)" : "var(--tx-3)",
