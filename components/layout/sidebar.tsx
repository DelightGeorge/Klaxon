  ...
  return (
    <aside style={{
      ...
      <div style={{
        ...
        borderBottom: "1px solid var(--bd-1)", flexShrink: 0,
      }}>
          ...
          if (!hasChildren) {
            return (
              <Link key={item.label} href={item.href!}
                ...
                style={{ justifyContent: collapsed ? "center" : "flex-start", padding: collapsed ? "9px 0" : "8px 12px", whiteSpace: "nowrap" }}>
                  ...
                  {item.children!.map(child => (
                    <Link key={child.href} href={child.href}
                      ...
                      <span style={{
                        ...
                        background: isActive(child.href) ? "var(--k)" : "var(--tx-3)",
                      }} />
                      {child.label}
                    </Link>
                  ))}
      ...
      <div style={{ padding: "8px 8px 14px", borderTop: "1px solid var(--bd-1)", display: "flex", flexDirection: "column", gap: 2, flexShrink: 0 }}>
        ...
        <button onClick={toggle}
          ...
          style={{
            ...
            fontFamily: "'DM Sans', sans-serif", fontWeight: 500, transition: "all 0.15s", width: "100%",
          }}
