// components/layout/klaxon-mark.tsx
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: s.gap }}>
      ...
      >
        ...
        <circle
          cx={cx} cy={cx} r={d}
          stroke="rgba(20,184,142,0.18)"
          strokeWidth="1"
          strokeDasharray="3 2.5"
        />
        {/* Arc 1: left → upper-right */}
        <path
          d={`M ${ax},${cx} A ${d},${d} 0 0,1 ${bx},${by}`}
          stroke="#14b88e"
          strokeWidth={s.sw}
          strokeLinecap="round"
        />
        ...
        <path
          d={`M ${bx2},${by2} A ${d},${d} 0 0,1 ${cx - d * 0.5},${by2}`}
          stroke="#14b88e"
          strokeWidth={s.sw}
          strokeLinecap="round"
        />
        ...
        <circle
          cx={cx} cy={cx} r={s.r2}
          fill="rgba(20,184,142,0.07)"
          stroke="#14b88e"
          strokeWidth={s.sw * 0.65}
        />
        {/* Endpoint dots */}
        {dots.map(([x, y], i) => (
